...
Please beware that as this project is a work in progress, it will be relatively volatile in changes and should be used with extreme caution in its current state.

A simple (in progress) WGPU-based game engine built in Rust and focused on customization especially in the realm of physics-based simulation. It relates entities and components as archetypes.
